...
imageUpload.addEventListener('change', (event) => {
    ...
    if (file) {
        ...
        reader.onload = (e) => {
            ...
            // If the image loads *too quickly* (e.g., from cache), originalImage.onload might already have fired
            // or won't fire. We use a setTimeout(0) to push this check to the end of the current event loop,
            // giving the browser a moment to process the `src` change.
            setTimeout(() => {
